...
WS_TESTS = test_room_broadcast test_cluster_s2s test_cluster_gossip_mesh test_security_extreme test_room_cleanup test_stress_fd_reuse test_ws_fragmentation_stress test_cross_talk_stress
